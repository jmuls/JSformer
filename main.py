...
from model.JSFormer import jsformer
...
def val(opt, actions, val_loader, model):
    with torch.no_grad():
        p1, p2, action_error_sum = step('test', opt, actions, val_loader, model)
        return p1, p2, action_error_sum
...
if __name__ == '__main__':
    ...
    model = jsformer(num_frame=opt.frames, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
